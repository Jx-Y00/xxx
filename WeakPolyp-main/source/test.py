...
if __name__=='__main__':
    class Config:
        def __init__(self, backbone, testset):
            ...
            self.snapshot       = self.backbone+'/KiTS19model.pth'
            ...
            self.test_image    = '/data/sam/baselines/nnUNet/yjx/weaksup/KiPA22/test_KiPA22/Frame'
            self.test_mask     = '/data/sam/baselines/nnUNet/yjx/weaksup/KiPA22/test_KiPA22/GT'
            ## other settings
            self.mode           = 'test'
            self.batch_size     = 64
            self.num_workers    = 4
    ...
    Test(Config('res2net50', 'test_KiTS19')).test_prediction()
    # Test(Config('pvt_v2_b2', 'test_Polyp-Skin')).test_prediction()
