...
class Train:
    ...
    def forward(self):
        ...
        for epoch in range(self.cfg.epoch):
            if epoch in [3, 6, 9, 12]:
                self.optimizer.param_groups[0]['lr'] *= 0.5  #在特定的epoch减半学习率
    ...
    def evaluate(self, epoch):
        ...
        if dice/cnt>self.max_dice:
            ...
            torch.save(self.model.state_dict(), self.cfg.backbone+'/KiTS19model.pth')
        self.model.train()
...
if __name__=='__main__':
    ...
    if not os.path.exists('/data/sam/baselines/nnUNet/yjx/weaksup/KiTS19-Processed'):
        preprocess('/data/sam/baselines/nnUNet/yjx/weaksup/KiTS19/train_KiTS19')
        preprocess('/data/sam/baselines/nnUNet/yjx/weaksup/KiTS19/test_KiTS19')
    ...
    class Config:
        def __init__(self, backbone):
            ...
            self.train_image    = '/data/sam/baselines/nnUNet/yjx/weaksup/KiTS19-Processed/train_KiTS19/Frame'
            self.train_mask     = '/data/sam/baselines/nnUNet/yjx/weaksup/KiTS19-Processed/train_KiTS19/Box'
            ...
            self.test_image    = '/data/sam/baselines/nnUNet/yjx/weaksup/KiTS19-Processed/test_KiTS19/Frame'
            self.test_mask     = '/data/sam/baselines/nnUNet/yjx/weaksup/KiTS19-Processed/test_KiTS19/GT'
            ## set the path of logging
            self.log_path       = self.backbone+'/KiTS19log'
